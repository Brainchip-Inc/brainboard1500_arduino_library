...
const char akida_model_path[] =
    "artifacts/NiclaV_VWW_PersonDet_EN_USBbottom_2026-06-14/vww_program";
const char akida_model_ip_version[] = "v1";
const char akida_model_akida_version[] = "2.5.0";
const char akida_selected_sequence_name[] =
    "artifact_vww_persondet_usbbottom";
...
const int64_t akida_layer_count = 0;
const int64_t akida_program_length_bytes = 183884;
const int64_t akida_input_rank = 3;
const int64_t akida_output_rank = 3;
const uint32_t akida_input_shape[] = {96, 96, 3};
...
const int64_t akida_last_layer_input_bits = 8;
